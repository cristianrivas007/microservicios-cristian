          ...
          <div className="cert-card">
            ...
            <div className="top-row">
              ...
              <div className="info-block">
                ...
                <p className="meta">Fecha: 09-05-2023</p>
                <p className="meta bold">Con una duración de 40 horas</p>
                <p className="desc">
                  Reconocimiento por la participación de Rivas Betancourt Cristian Paul
                  en el taller de <strong>Microservicios en NET</strong>, realizado
                  del 2 al 5 de mayo del 2023.
                </p>
              </div>
            </div>
